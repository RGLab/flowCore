...
#  - "LargeDecisionTrees.xml" Gating-ML file                                       #
# applied to                                                                       #
...
gateFile <- system.file("unitTests/standardsCompliance/Gating-ML_ComplianceTests/InOutEventsTests/Gating-ML_Files","LargeDecisionTrees.xml",package="flowCore")

...
setMethod("identifier","filterResult",function(object) object@frameId)
setMethod("==",signature("flowFrame","filterResult"),function(e1,e2) {
	i1 = identifer(e1)
	i2 = identifier(e2)
	(length(i1) == 0 || length(i2) == 0 || i1 == i2)
})
#Does S4 do this for us automagically? I don't know!
setMethod("==",signature("filterResult","flowFrame"),function(e1,e2) e2==e1)

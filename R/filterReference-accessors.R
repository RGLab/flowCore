## Everything is just passed to the referenced filter. This may be better
## handled by the type system by having "real" filters inherit from
## concreteFilter (or something) and then simply having a setAs(), but 
...
setMethod("parameters",
          signature("filterReference"),
          function(object)
          parameters(as(object, "concreteFilter")))
...
setMethod("summarizeFilter",
          signature("filterResult", "filterReference"),

...
\begin{abstract}
  ...
  (FH-HCS), generating large complex data sets often in clinical
  ...
  extensible research platform that enables colaboration between
  bioinformaticians, computer scientists, statisticians, biologists
  and clinicians. This platform will foster the developement of novel
  analytic methods for flow cytometry.
  
  \paragraph*{Conclusions:} 
  The software has been applied in the analysis of various data sets
  and its data structures have been proven to be highly efficient in
  capturing and organizing the analytic work flow. A number of
  additional Bioconductor packages successfully build on the
  infrastructure provided by \Rpackage{flowCore}, opening new avenues
  for flow data analysis.

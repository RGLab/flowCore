...
\begin{abstract}
  ...
  not advanced sufficiently far from the initial small-scale studies to
  support the large complex data sets generated in FH-HCS
  applications.
      
  \paragraph*{Results:} We developed a set of flexible computational
...
software language as the Bioconductor package \Rpackage{flowCore}.
...
\section*{Results and Discussion}
  ...
  simple line of code produces the output shown in Figure~2\ref{flowQ}:

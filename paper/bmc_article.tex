...
open development of tools for their coherent analysis. In our
implementation of \Rpackage{flowCore} we rely on two important lessons
learned from the field of gene expression data analysis: the first
being the importance of data structures that reflect the underlying
data and facilitate the manipulations that are of most interest, while
the second is the importance of a modular architecture that allows for
many developers to extend and use the underlying infrastructure and to
combine tools in complex work flows.  \Rpackage{flowCore} implements
such computationally efficient data structures and a range of
...
software that also adheres to the standard and vice versa.
...
operation. A very basic matrix of density plots is shown in Figure
...
progress and the outcome of an anlysis.
...
\section*{Figures}
  ...
  \begin{figure}[hp]
    \centering
    \includegraphics{Figure1-flowCoreFrameWork.jpg}

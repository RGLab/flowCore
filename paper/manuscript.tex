...
gap.  
%% EAS: I think we mention flowCore before talking about data structures and
% methods.  We should first say explicity that we have a solution for
% the missing shared platform.
...
%In this paper, we propose R data structures to handle FCM data
%through the main steps of importing, storing, assessing and
%preprocessing. 
%These structures, along with a range of specialized
%methods for compensation, transformation, gating and additional
%preprocessing steps, are implemented in the newly developed
%Bioconductor package flowCore.  flowCore is a freely available,
%sophisticated and extensible FCM data analysis platform that enables
%researchers to efficiently handle FC-HCS data and enables open
%development of new methods and tools for their coherent
%analysis.
